...
void CLuaManager::LoadCFunctions ( void )
{
    ...
    CLuaCFunctions::AddFunction ( "canElementFloat", CLuaFunctionDefs::CanElementFloat );
    ...
    CLuaCFunctions::AddFunction ( "setElementCanFloat", CLuaFunctionDefs::SetElementCanFloat );
